...
"	border: none;\n"
"}font-style: italic;")
        self.reduccion = QPushButton(self.centralwidget)
        self.reduccion.setObjectName(u"reduccion")
        self.reduccion.setGeometry(QRect(510, 60, 211, 41))
        self.reduccion.setFont(font)
        self.reduccion.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.reduccion.setStyleSheet(u"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.back.setText("")
        self.next.setText("")
        self.reduccion.setText(QCoreApplication.translate("MainWindow", u"Reducci\u00f3n", None))
    # retranslateUi
