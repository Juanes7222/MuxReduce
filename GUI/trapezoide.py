...
class TrapezoidWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.setMinimumSize(500, (self.trapezoid_height + self.pin_count * 4 + 20)*3)
        self.positions = {}
    ...
    def draw_conections(self, painter: QPainter):
        ...
        for i in range(self.pin_count):
            ...
            if DT.Respuesta_final[i] == 0:
                pen = QPen(QColor("#00FF00"), 3)  # Verde para 0V
            elif DT.Respuesta_final[i] == 1:
                pen = QPen(QColor("#0000FF"), 3)  # Azul para 5V
            elif DT.Respuesta_final[i] == "A":
                pen = QPen(QColor("#FF0000"), 3)  # Rojo para A
            else:
                pen = QPen(QColor("#FFFF00"), 3)  # Amarillo para A'
